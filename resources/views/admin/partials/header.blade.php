...
<div class="page " style="margin-bottom: -36rem !important;">
                        ...
                        <ul class="list-unstyled mb-0" id="header-notification-scroll">
                            ...
                            <li class="dropdown-item">
                                <div class="d-flex align-items-start">
                                    ...
                                    <div class="flex-grow-1 d-flex align-items-center justify-content-between">
                                        <div>
                                            <p class="mb-0 fw-semibold"><a href="default-chat.html">New Mails
                                                    Received</a>
                                            </p>
                            ...
                            <li class="dropdown-item">
                                <div class="d-flex align-items-start">
                                    ...
                                    <div class="flex-grow-1 d-flex align-items-center justify-content-between">
                                        <div>
                                            <p class="mb-0 fw-semibold"><a href="default-chat.html">New Order
                                                    Received</a>
                                            </p>
                            ...
                            <li class="dropdown-item">
                                <div class="d-flex align-items-start">
                                    <div class="pe-2">
                                        <span
                                            class="avatar avatar-md bg-info-gradient box-shadow-primary avatar-rounded"><i
                                    ...
                                    <div class="flex-grow-1 d-flex align-items-center justify-content-between">
                                        <div>
                                            <p class="mb-0 fw-semibold"><a href="default-chat.html">Madeleine<span
                                                        class="text-muted fs-12 fw-normal ps-1 d-inline-block"> 3 hours
                                                        ago </span></a>
                                            </p>
                                            <span class="text-muted fw-normal fs-12 header-notification-text">Hey! there
                                                I'
                                                am available....</span>
                                        </div>
                                        <div>
                                    ...
                                    <div class="flex-grow-1 d-flex align-items-center justify-content-between">
                                        <div>
                                            <p class="mb-0 fw-semibold"><a href="default-chat.html">Anthony<span
                                                        class="text-muted fs-12 fw-normal ps-1 d-inline-block"> 5 hours
                                                        ago </span></a>
                                            </p>
                                    ...
                                    <div class="flex-grow-1 d-flex align-items-center justify-content-between">
                                        <div>
                                            <p class="mb-0 fw-semibold"><a href="default-chat.html">Olivia<span
                                                        class="text-muted fs-12 fw-normal ps-1 d-inline-block">45
                                                        mintues ago </span></a>
                                            </p>
                                            <span class="text-muted fw-normal fs-12 header-notification-text">New
                                                Schedule
                                    ...
                                    <div class="flex-grow-1 d-flex align-items-center justify-content-between">
                                        <div>
                                            <p class="mb-0 fw-semibold"><a href="default-chat.html">Sanderson<span
                                                        class="text-muted fs-12 fw-normal ps-1 d-inline-block">20
                                                        mintues ago </span></a>
                                            </p>
                                            <span class="text-muted fw-normal fs-12 header-notification-text">New
                                                Schedule
                                    ...
                                    <div class="flex-grow-1 d-flex align-items-center justify-content-between">
                                        <div>
                                            <p class="mb-0 fw-semibold"><a href="default-chat.html">Senrio<span
                                                        class="text-muted fs-12 fw-normal ps-1 d-inline-block"> 10 hours
                                                        ago </span></a>
                                            </p>
                                            <span class="text-muted fw-normal fs-12 header-notification-text">New
                                                product
