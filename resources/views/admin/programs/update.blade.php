                        ...
                        <form action="{{ route('programs.update', $program->id) }}" method="POST"
                            ...
                            <div class="form-group mb-2">
                                ...
                                <input type="text" class="form-control @error('rating') is-invalid @enderror"
                                    name="rating" id="rating" placeholder="Enter the Rating"
                                ...
                                <select class="form-control @error('expert') is-invalid @enderror" name="expert_id">
                                    ...
                                    @foreach ($experts as $expert)
                                        <option value="{{ $expert->id }}"
                                            {{ $program->expert_id == $expert->id ? 'selected' : '' }}>
                                            {{ $expert->name }}</option>
                                    @endforeach
                                </select>
                                @error('expert')
                                ...
                                @if ($program->programming_tovideo_url)
                                    <div class="mt-2">
                                        ...
                                        <video width="200" height="200" controls>
                                            <source
                                                src="{{ asset('uploads/videos/' . $program->programming_tovideo_url) }}"
                                                type="video/mp4">
                            ...
                            <div class="form-group mb-2">
                                ...
                                <input type="text" class="form-control @error('program_for') is-invalid @enderror"
                                    name="program_for" value="{{ $program->program_for }}">
                                @error('program_for')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group mb-2">
                                ...
                                <input type="text" class="form-control @error('enroll_user') is-invalid @enderror"
                                    name="enroll_user" value="{{ $program->enroll_user }}">
                                @error('enroll_user')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    <textarea name="program_description" class="ckeditor @error('program_description') is-invalid @enderror"
                                        id="ckeditor">{{ $program->program_description }}</textarea>
