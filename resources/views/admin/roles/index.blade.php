                ...
                <div class="row tabelhed d-flex justify-content-between">
                    <div class="col-lg-2 col-md-2 col-sm-2 d-flex">
                        ...
                        <a href="{{ route('roles.create') }}"
                            ...
                            <i class="fe fe-plus mx-1 align-middle"></i>Create Roles
                        </a>
                    </div>
                    ...
                    <div class="col-lg-10 col-md-10">
                        <div class="right-item d-flex justify-content-end">
                            ...
                            <!-- <form action="" method="GET" class="d-flex">
                                ...
                                <a href="{{ route('roles.index') }}" class="btn-sm reload-btn">
                                    ...
                                    <div class="col-xl-12 d-flex float-end">
                                        <div class="items paginatee">
                                            <select class="form-select m-0 items" name="items" id="items"
                                                ...
                                                <option value='10'
                                                    {{ isset($items) ? ($items == '10' ? 'selected' : '' ) : '' }}>10
                                                </option>
                                                <option value='20'
                                                    {{ isset($items) ? ($items == '20' ? 'selected' : '' ) : '' }}>20
                                                </option>
                                                <option value='30'
                                                    {{ isset($items) ? ($items == '30' ? 'selected' : '' ) : '' }}>30
                                                </option>
                                                <option value='40'
                                                    {{ isset($items) ? ($items == '40' ? 'selected' : '' ) : '' }}>40
                                                </option>
                                                <option value='50'
                                                    {{ isset($items) ? ($items == '50' ? 'selected' : '' ) : '' }}>50
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                            ...
                            <table id="example" class="table table-striped table-bordered">
                                ...
                                <tr data-entry-id="{{ $value->id }}">
                                    ...
                                    <td class="text-center">
                                        <a href="" class="btn btn-sm btn-icon p-1">
                                            <i class="mdi mdi-pencil" data-bs-toggle="tooltip" data-bs-offset="0,4"
                                                data-bs-placement="top" title="Edit"></i>
                                        </a>

                                        <button type="submit" class="btn btn-sm btn-icon p-1 delete-record" route=""><i
