            ...
            <div class="col-lg-12">
                <div class="row tabelhed d-flex justify-content-between">
                    <div class="col-lg-2 col-md-2 col-sm-2 d-flex">
                            <a href="{{ route('categories.create') }}" class="btn btn-primary btn-lg float-left">Add Category</a>
                    </div>
                                ...
                                <thead>
                                    ...
                                    @foreach($categories as $key => $category)
                                        <tr data-entry-id="{{ $category->id }}">
                                            ...
                                            <a href="{{ route('categories.delete', ['id' => $category->id]) }}" class="btn btn-danger" data-toggle="modal" data-target="#exampleModal{{ $category->id }}">Delete</a>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <!-- Delete Form -->
                <form id="deleteForm{{ $category->id }}" action="{{ route('categories.delete', ['id' => $category->id]) }}" method="POST">
                    @csrf
                    @method('DELETE')
