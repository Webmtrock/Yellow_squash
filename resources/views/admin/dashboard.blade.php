                                    ...
                                    <div class="activity1">
                                        <div class="activity-blog">
                                            ...
                                            <div class="activity-details d-flex">
                                                <div><b><span class="text-dark"> Mr John </span> </b> Started following
                                                    you
                                        ...
                                        <div class="activity-blog">
                                            ...
                                            <div class="activity-details d-flex">
                                                <div><b><span class="text-dark"> Lily </span> </b> 1 Commented applied
                                                    <span class="d-flex text-muted fs-11">01 July 2020</span>
                                                </div>
                                                <div class="ms-auto fs-13 text-dark fw-semibold"><span
                            ...
                            <div class="card custom-card">
                                ...
                                <div class="card-body pt-2 pb-2">
                                    ...
                                    <div class="d-md-flex align-items-center browser-stats">
                                        <div class="d-flex me-1">
                                            <i
                                                class="ri-opera-fill text-fixed-white bg-danger-gradient me-2 logo-icon"></i>
                                    ...
                                    <div class="d-md-flex align-items-center browser-stats">
                                        <div class="d-flex me-1">
                                            <i
                                                class="ri-edge-fill text-fixed-white bg-info-gradient me-2 logo-icon"></i>
                                    ...
                                    <div class="table-responsive deals-table">
                                        <table class="table text-nowrap table-hover border table-bordered">
                                            <thead class="border-top">
                                                <tr>
                                                    <th class="bg-transparent border-bottom-0 w-5 text-uppercase">S.no
                                                    </th>
                                                    ...
                                                    <th class="bg-transparent border-bottom-0 text-uppercase">Amount
                                                    </th>
                                                    <th class="bg-transparent border-bottom-0 text-uppercase">Status
                                                    </th>
                                                    <th class="bg-transparent border-bottom-0 text-uppercase">Action
                                                    </th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                    ...
                                                    <td>
                                                        <div class="d-flex">
                                                            ...
                                                            <div class="ms-2 mt-0 mt-sm-2 d-block">
                                                                ...
                                                                <span
                                                                    class="fs-12 text-muted">jacobthomson@gmail.com</span>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td class="text-muted fs-15 fw-semibold">20-11-2020 </td>
